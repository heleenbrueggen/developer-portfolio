...
bibliography: files/Analysis/references.bib
---

For the course *Markup languages and Reproducible Research* we have to create a [reproducible research project](files/reproducible-script.zip). The following is that file. 
...
# Loading the data
d1 <- Hmisc::sasxport.get("files/Analysis/Data/DEMO_I.XPT")
d2 <- Hmisc::sasxport.get("files/Analysis/Data/BPX_I.XPT")
d3 <- Hmisc::sasxport.get("files/Analysis/Data/BMX_I.XPT")
d4 <- Hmisc::sasxport.get("files/Analysis/Data/GHB_I.XPT")
d5 <- Hmisc::sasxport.get("files/Analysis/Data/TCHOL_I.XPT")
